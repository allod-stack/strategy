...
### 1. Rename llm-memory to agent-memory

Plan: `notes/allod/rename-llm-memory-plan.md`
...
### 2. Parameterize ai-agents.nix

Plan: `dev-plans/parameterize-ai-agents.md`
...
### 3. Per-VM checkout path uniqueness

Plan: `dev-plans/per-vm-checkout-uniqueness.md`
...
### 4. Split agent-memory into public and private

Plan: `dev-plans/split-agent-memory.md`
...
Plan: `dev-plans/agent-isolation-dev-plan.md` (slimmed)
